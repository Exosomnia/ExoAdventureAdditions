...
public class AdventureManager {
    ...
    public final static GameRules.Key<GameRules.BooleanValue> RULE_ADVENTURE_STARTED = GameRules.register("adventureStarted", GameRules.Category.MISC, GameRules.BooleanValue.create(false));
    ...
    public static void serverStartEvent(ServerStartedEvent event) {
        ...
        if (level.getGameTime() == 0 && Config.newWorldsIntro) {
            ...
            border.setSize(16); // defaults to 30000000 million
        }
    }
